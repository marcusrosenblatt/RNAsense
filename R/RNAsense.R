...
#'
#' @param dataset Object of class SummarizedExperiment, output of \link{SummarizedExperiment}, as assays use a numeric matrix with your RNAseq count data, rows correspond to different genes, columns correspond to different experiments, as rowData provide a [S4Vectors::DataFrame] with columns name (geneID) and genename (the gene names), as colData provide a [S4Vectors::DataFrame] with columns condition, time and replicate
