...
resultFC <- getFC(dataset = mydata, myanalyzeConditions = analyzeConditions, cores = nrcores, mytimes = times)
head(resultFC)
```
...
resultSwitch <- getSwitch(dataset = mydata, experimentStepDetection = "WT", cores = nrcores, mytimes = times)
head(resultSwitch)
```
